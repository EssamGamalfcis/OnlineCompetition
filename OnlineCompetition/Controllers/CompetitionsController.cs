...
namespace OnlineCompetition.MVC.Controllers
{
    ...
    public class CompetitionsController : Controller
    {
        ...
        //        //    //newObj.RightAnswerCode = competitionsQuestions.RightCompetitionQuestionAnswerId == null ? null : answers.FirstOrDefault(x => x.Id == competitionsQuestions.RightCompetitionQuestionAnswerId.Value).Id;
        ...
        //                    //updateRightAnswer.RightCompetitionQuestionAnswerCode = competitionQuestionAnswer.Id;
        //                    await _db.SaveChangesAsync();
        ...
        //                if (item.IsRightAnswer == true)
        //                {
        //                    //competitionQuestion.RightCompetitionQuestionAnswerCode = competitionQuestionAnswer.Id;
        //                    await _db.SaveChangesAsync();
